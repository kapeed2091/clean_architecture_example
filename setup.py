...
version = get_version('clean_architecture_example', '__init__.py')
...
setup(
    ...
    url='https://github.com/kapeed2091/clean_architecture_example',
    packages=[
        'clean_arch_app',
    ],
    ...
    zip_safe=False,
    keywords='clean_architecture_example',
    classifiers=[
