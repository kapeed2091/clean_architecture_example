...
ALLOWED_HOSTS = [
    "clean-architecture-example-prod.apigateway.in",
    "clean-architecture-example-alpha.apigateway.in",
    "clean-architecture-example-beta.apigateway.in",
    "clean-architecture-example-gamma.apigateway.in",
    "127.0.0.1",
    "localhost"
]
...
LOGGING = {
    ...
    'formatters': {
        ...
        'console': {
            'format': "[%(request_id)s] [django_settings - "+os.environ.get("STAGE", "local")+
    ...
    'loggers': {
        '': {
            'handlers': ['console', 'sentry', 'logentries'],
            'level': 'INFO',
            'propagate': False,
        },
        'dsu.error': {
...
# ****************** App Source Config ******************
CLEAN_ARCHITECTURE_EXAMPLE_SOURCE = "clean-architecuture-example-source"
