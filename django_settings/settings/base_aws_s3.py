...
STATICFILES_STORAGE = 'django_settings.common.aws.custom_storages.StaticStorage'
DEFAULT_FILE_STORAGE = 'django_settings.common.aws.custom_storages.MediaStorage'
